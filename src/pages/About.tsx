    ...
    <div className="min-h-screen pt-24 pb-12 grid-bg">
      <div className="container max-w-3xl">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
          <h1 className="text-4xl font-display font-bold neon-text mb-2">About ViaR</h1>
        ...
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {[
              ...
              { icon: Users, title: "Accessibility", desc: "Make career exploration available to every student regardless of background or experience." },
